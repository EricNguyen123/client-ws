...
export const menuAccount = () => {
  ...
  return [
    ...
    },
    {
      role: RoleEnum.Admin,
      option: <Options/>,
      optionActive: <OptionsActive/>,
      icon: <Boxes className='w-4 h-4'/>,
      title: <span className="text-sm">{t('products.title')}</span>,
      href: config.routes.private.products,
      items: [
        {
          role: RoleEnum.Admin,
          option: undefined,
          ...
          title: <span className="text-sm">{t('products.add')}</span>,
          href: config.routes.private.addProduct,
          items: [],
        },
        {
          role: RoleEnum.Admin,
          ...
          title: <span className="text-sm">{t('products.list')}</span>,
          href: config.routes.private.products,
          items: [],
        },
        {
          ...
          title: <span className="text-sm">{t('products.color')}</span>,
          href: config.routes.private.colorCode,
          items: [],
        },
        {
          role: RoleEnum.Admin,
          ...
          title: <span className="text-sm">{t('products.size')}</span>,
          href: config.routes.private.sizeCode,
          items: [],
        }
      ],
    },
